...
public class AutoController {
   //   private Auto [] autos = new Auto[100];  -> deklaracja pustej tablicy aut o długości 100(aut)
    // ale robimy to za pomocą list:
   ...
   public Auto addAuto(String brand, String model, Engine engineType, Fuel fuelType, double price) {
       ...
       // zapis do listy aut (zamówionych przez użytkowników
       autos.add(auto);
       return auto;
   }
